...
def normalize_marker_version(text):
    """The generated marker embeds the live plugin.json version. Normalize it so
    golden and self-render byte comparisons stay stable across superrelease's own
    version bumps (a release changes plugin.json → every marker would otherwise
    drift)."""
