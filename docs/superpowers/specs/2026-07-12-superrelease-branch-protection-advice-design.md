...
4. init은 `config.decisions`에 한 항목을 남긴다: `{ "topic": "branch-protection", "answer": "advised" | "already-protected" | "unknown", "rationale": "<근거>", "source": "scan", "decidedAt": "<date>" }`. 재init 시 여전히 미보호면 다시 안내한다(갭이 살아있으므로 적절).
